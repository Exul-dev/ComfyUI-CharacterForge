...
class HumanAnatomy(AnatomyComponent):
    ...
    def __init__(self,*,body_type=None,height=None,proportions=None,musculature=None,
                 body_fat=None,neck=None,shoulders=None,torso=None,chest=None,
                 ribcage=None,back=None,arms=None):
        super().__init__()
    ...
    def validate(self):
        super().validate()
        for c in (self.body_type,self.height,self.proportions,self.musculature,
                  self.body_fat,self.neck,self.shoulders,self.torso,
                  self.chest,self.ribcage,self.back,self.arms):
            c.validate()
